  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-6" style={{ backgroundColor: "rgba(10,8,5,0.85)", backdropFilter: "blur(4px)" }}>
      <div style={{ background: "#1a1410", border: "0.5px solid rgba(184,145,58,0.25)", borderRadius: 12, padding: "28px 24px", maxWidth: 400, width: "100%" }} className="relative max-h-[90vh] overflow-y-auto">
        ...
        {/* Wordmark */}
        <div onClick={handleTitleTap} style={{ textAlign: "center", marginBottom: 4, cursor: "default", userSelect: "none" }}>
          <div className="font-serif text-2xl text-foreground tracking-[0.25em]">DABAR</div>
          <p className="text-gold scripture-italic text-xs tracking-wider mt-0.5">
            דָּבָר · The Word
          </p>
        </div>

        <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 22, fontWeight: 400, color: "#f0ead8", textAlign: "center", marginTop: 16, marginBottom: 4, letterSpacing: "0.04em" }}>
          {mode === "signup" ? "Begin your journey" : "Welcome back"}
        </h3>
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 300, color: "rgba(240,234,216,0.45)", textAlign: "center", marginBottom: 18, letterSpacing: "0.03em", lineHeight: 1.5 }}>
          {mode === "signup"
            ? (nativeIOS ? "No payment required in this iOS version." : "30 days free · No card needed.")
            : "Your spiritual journey continues."}
        </p>

        {message && (
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 300, color: "rgba(184,145,58,0.7)", textAlign: "center", marginBottom: 14, letterSpacing: "0.03em", lineHeight: 1.5 }}>
            {message}
          </p>
        )}

        {/* Social-first: Apple (per Apple HIG App Store 4.8), then Google */}
        {!nativeIOS && (
          <div className="space-y-2.5 mb-4">
            <button
              ...
              className="w-full font-body text-sm py-2.5 rounded-lg bg-black text-white border border-white/15 hover:bg-zinc-900 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="w-full font-body text-sm py-2.5 rounded-lg bg-white text-[#3c4043] border border-black/10 hover:bg-gray-50 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <span className="text-[11px] text-muted-foreground font-body tracking-wider">or</span>
              <div className="flex-1 h-px bg-border" />
            </div>
          </div>
        )}
        ...
        <p className="text-center mt-5 text-xs font-body text-muted-foreground">
          {mode === "signup" ? (
            <>
              Have an account?{" "}
        ...
        {/* Trust footer */}
        <div className="mt-5 pt-4 border-t border-border/50 flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-[10px] font-light tracking-wide text-muted-foreground/50 text-center">
